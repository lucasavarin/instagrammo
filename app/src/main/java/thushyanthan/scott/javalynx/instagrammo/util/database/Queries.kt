...
object Queries {
     const val SQL_CREATE_ENTRIES_POSTS =
        "CREATE TABLE ${FeedReaderContract.PostEntry.TABLE_NAME} ("+
                ...
                "FOREIGN KEY (${FeedReaderContract.PostEntry.COLUMN_NAME_PROFILE_ID})" +
                " REFERENCES ${FeedReaderContract.ProfileEntry.TABLE_NAME} (${FeedReaderContract.ProfileEntry.COLUMN_NAME_PROFILE_ID}))"

     const val SQL_CREATE_ENTRIES_FOLLOWERS =
        "CREATE TABLE ${FeedReaderContract.FollowersEntry.TABLE_NAME}("+
                ...
                "FOREIGN KEY (${FeedReaderContract.FollowersEntry.COLUMN_NAME_PROFILE_ID})"+
                " REFERENCES ${FeedReaderContract.ProfileEntry.TABLE_NAME} (${FeedReaderContract.ProfileEntry.COLUMN_NAME_PROFILE_ID}))"

     const val SQL_CREATE_ENTRIES_PROFILE =
        "CREATE TABLE ${FeedReaderContract.ProfileEntry.TABLE_NAME} ("+
