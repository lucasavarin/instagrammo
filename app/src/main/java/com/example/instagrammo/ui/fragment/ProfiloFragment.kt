...
import com.example.instagrammo.model.business.ProfilePostBean
import com.example.instagrammo.model.business.Session
import com.example.instagrammo.model.rest.request.ProfileWrapperRest
...
class ProfiloFragment(private val profileId: String) : Fragment() {
    ...
    override fun onCreateView(
        ...
        RetrofitController.getClient.getProfile(this.profileId.toInt())
            .enqueue(object : Callback<ProfileWrapperRest> {
                ...
                override fun onResponse(
                    ...
                    fillDataUser(
                        description,
                        imageUrl,
                        response!!.body()!!.payload[0].followersNumber,
                        response!!.body()!!.payload[0].postsNumber
                    )
                }
            })
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        buttonProfilo.visibility =
            if (this.profileId.toInt() == Session.profileId) View.VISIBLE else View.INVISIBLE
        ...
        RetrofitController.getClient.getProfilePost(this.profileId.toInt())
            .enqueue(object : Callback<ProfilePostBean> {
    ...
    fun fillDataUser(desc: String, image: String, nAmici: String, nPosts: String) {
        Picasso.get().load(image).resize(175, 175).transform(CircleTrasformation())
            .into(Profile_photo)
