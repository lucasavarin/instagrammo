...
import kotlinx.android.synthetic.main.add_layout_thirt_fragment.view.confButton
import kotlinx.android.synthetic.main.custom_view_layout.*
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class AddThirdFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootestView : View = inflater.inflate(R.layout.add_layout_thirt_fragment, container, false)
            ...
            Picasso.get().load(SessionAddFragmentData.urlImage[SessionAddFragmentData.position])
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        backButton.setOnClickListener { utilities_project.deleteFragment(AddThirdFragment(), activity!!) }
            ...
            override fun onResponse(
                ...
                if(response.isSuccessful){
                    if(response.body()!!.result){
                        ...
                        utilities_project.deleteFragment(AddThirdFragment(), activity!!)
                        utilities_project.deleteFragment(AddSecondFragment(), activity!!)
                    }
                }
            }
